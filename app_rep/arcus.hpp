...
namespace arcus
{
    ...
    public:
         ...
         * @return sucess:true, fail:false
         */
        cached_data *get(std::string key, const uint64_t from, const uint64_t to, memcached_return_t *rc);
        ...
        /*
         * update expire time of given key.
         *
         * @param key
         * @param exptime (-1:sticky item, 0:not-expired)
         * @param rc
         * @return sucess:true, fail:false
         */
    ...
    private:
        ...
        connection_pool *_backup_pool; 
#else
        /*
         * release connection pool of given position
         */
    ...
    public:
        ...
        void add(std::string admin, std::string service_code, int32_t initial, int32_t max, uint64_t timeout);
        size_t size();
        connection_pool *pool(size_t i);
