 ...
 *
 * @author Ronnie Dong (https://github.com/ronniedong)
 * @version 1.1
 */
public class Expect {
     ...
     * @throws IOException most unlikely
     */
    ...
    /**
     * @param str Convenience method to send a string to output handle
     */
    ...
    /**
     * @param toWrite Write a byte array to the output handle, notice flush()
     */
     ...
     * @param list    List of Java {@link Pattern}s used for match the internal
     ...
     * @throws TimeoutException when expect times out
     * @throws EOFException     when EOF is encountered
     * @throws IOException      when there is a problem reading from the InputStream
     */
     ...
     * </pre>
     *
     * @param duplicatedTo call with null if you want to turn off
     */
